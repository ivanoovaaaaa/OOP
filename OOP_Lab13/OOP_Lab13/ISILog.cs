...
namespace OOP_Lab13
{
    public static class ISILog
    {
        public static void WriteLogInfo()               /// запись в файл лога инфы о работе самого логгера
        {
            string logPath = Path.GetFullPath(@"D:\3 sem\OOP\git_oop\OOP\OOP_Lab13\OOP_Lab13\isilog.txt");
        ...
        {
            string logPath = Path.GetFullPath(@"D:\3 sem\OOP\git_oop\OOP\OOP_Lab13\OOP_Lab13\isilog.txt");
            string logFile = ISILog.ReadLog();                                  /// string с самим логом полностью
