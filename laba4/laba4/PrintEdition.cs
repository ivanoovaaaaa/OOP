...
public abstract class PrintEdition
{
    ...
    public PrintEdition(string Name, int Year, string Binding, string Author, string Person, string Publishing)
    {
        this.Name = Name;
        this.Year = Year;
    ...
    public override bool Equals(object obj)
    {
        ...
        PrintEdition Bookname = obj as PrintEdition;
        if (Bookname as PrintEdition == null)
        {
            return false;
        }
